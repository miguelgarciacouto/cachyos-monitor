...
* **[CPU Schedulers](https://wiki.cachyos.org/kernel/schedulers/)** - Explains the philosophy behind the Burst-Oriented Response Enhancer (BORE) and why it prioritizes interactive gaming tasks.
* **[System monitoring](https://wiki.archlinux.org/title/System_monitoring)** - The holy grail for understanding Linux system states.
